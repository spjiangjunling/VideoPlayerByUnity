...
public class TestReporter : MonoBehaviour
{
	...
	void threadLogTest()
	{
		...
		//	GameLogger.Log("Test Log from Thread");
		//	GameLogger.LogWarning("Test Warning from Thread");
		//	GameLogger.LogError("Test Error from Thread");
		//}
	}
	...
	void Update()
	{
		...
		//	GameLogger.Log("Test Log " + currentLogTestCount);
		//	GameLogger.LogError("Test LogError " + currentLogTestCount);
		//	GameLogger.LogWarning("Test LogWarning " + currentLogTestCount);
		//	drawn++;
		//	currentLogTestCount++;
		//}
		...
		//if (elapsed >= 1) {
		//	elapsed = 0;
		//	GameLogger.Log("One Second Passed");
		//}
	}
