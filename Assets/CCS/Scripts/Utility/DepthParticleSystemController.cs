...
public class DepthParticleSystemController : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        m_RenderList.AddRange(transform.GetComponentsInChildren<Renderer>());
        if (p != null)
        ...
        int rendercount = m_RenderList.Count;
        for (int i = 0; i < rendercount; ++i)
        {
            m_RenderList[i].sortingOrder = Depth;
        }
